...
#######################################
    ...
    def customHelp(self, curout):
        ...
        qexamples.append(["","dom_search\na353d4c9-2fa1-4b9b-8919-08ac1db9772a","Provide a UUID to retrieve structurally (based on DOM, files, links) similar submissions from URLScan."])
